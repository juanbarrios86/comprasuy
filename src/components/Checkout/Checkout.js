...
export const Checkout = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (values.nombre.length < 3) {
            ...
            Alerta("error","Datos incompletos", "Ingrese un nombre válido")
           
            return
        }
        if (values.apellido.length < 3) {
            Alerta("error","Datos incompletos", "Ingrese un apellido válido")
            return
        }
        if (values.email.length < 3) {
            Alerta("error","Datos incompletos", "Ingrese un email válido")
            return
        }
        if (values.tel.length < 7) {
            Alerta("error","Datos incompletos", "Ingrese un teléfono válido")
            return
        }
